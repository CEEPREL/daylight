...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function updateSuspenseComponent(current, workInProgress, renderLanes) {
        var JSCompiler_object_inline_componentStack_2732;
        var JSCompiler_object_inline_stack_2731 = workInProgress.pendingProps;
        shouldSuspendImpl(workInProgress) && (workInProgress.flags |= 128);
        var JSCompiler_object_inline_message_2729 = !1;
        var didSuspend = 0 !== (workInProgress.flags & 128);
        (JSCompiler_object_inline_componentStack_2732 = didSuspend) || (JSCompiler_object_inline_componentStack_2732 = null !== current && null === current.memoizedState ? !1 : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
        JSCompiler_object_inline_componentStack_2732 && (JSCompiler_object_inline_message_2729 = !0, workInProgress.flags &= -129);
        JSCompiler_object_inline_componentStack_2732 = 0 !== (workInProgress.flags & 32);
        workInProgress.flags &= -33;
        if (null === current) {
            if (isHydrating) {
                JSCompiler_object_inline_message_2729 ? pushPrimaryTreeSuspenseHandler(workInProgress) : reuseSuspenseHandlerOnStack(workInProgress);
                if (isHydrating) {
                    var JSCompiler_object_inline_digest_2730 = nextHydratableInstance;
                    var JSCompiler_temp;
                    if (!(JSCompiler_temp = !JSCompiler_object_inline_digest_2730)) {
                        c: {
                            var instance = JSCompiler_object_inline_digest_2730;
                    ...
                    JSCompiler_temp && (warnNonHydratedInstance(workInProgress, JSCompiler_object_inline_digest_2730), throwOnHydrationMismatch(workInProgress));
                }
                JSCompiler_object_inline_digest_2730 = workInProgress.memoizedState;
                if (null !== JSCompiler_object_inline_digest_2730 && (JSCompiler_object_inline_digest_2730 = JSCompiler_object_inline_digest_2730.dehydrated, null !== JSCompiler_object_inline_digest_2730)) return isSuspenseInstanceFallback(JSCompiler_object_inline_digest_2730) ? workInProgress.lanes = 32 : workInProgress.lanes = 536870912, null;
                popSuspenseHandler(workInProgress);
            }
            JSCompiler_object_inline_digest_2730 = JSCompiler_object_inline_stack_2731.children;
            JSCompiler_temp = JSCompiler_object_inline_stack_2731.fallback;
            if (JSCompiler_object_inline_message_2729) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_stack_2731 = mountSuspenseFallbackChildren(workInProgress, JSCompiler_object_inline_digest_2730, JSCompiler_temp, renderLanes), JSCompiler_object_inline_message_2729 = workInProgress.child, JSCompiler_object_inline_message_2729.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_message_2729.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2732, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2731;
            if ("number" === typeof JSCompiler_object_inline_stack_2731.unstable_expectedLoadTime) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_stack_2731 = mountSuspenseFallbackChildren(workInProgress, JSCompiler_object_inline_digest_2730, JSCompiler_temp, renderLanes), JSCompiler_object_inline_message_2729 = workInProgress.child, JSCompiler_object_inline_message_2729.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_message_2729.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2732, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress.lanes = 4194304, JSCompiler_object_inline_stack_2731;
            pushPrimaryTreeSuspenseHandler(workInProgress);
            return mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_digest_2730);
        }
        var prevState = current.memoizedState;
        if (null !== prevState && (JSCompiler_object_inline_digest_2730 = prevState.dehydrated, null !== JSCompiler_object_inline_digest_2730)) {
            if (didSuspend) workInProgress.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress), workInProgress.flags &= -257, workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes)) : null !== workInProgress.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress), workInProgress.child = current.child, workInProgress.flags |= 128, workInProgress = null) : (reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_message_2729 = JSCompiler_object_inline_stack_2731.fallback, JSCompiler_object_inline_digest_2730 = workInProgress.mode, JSCompiler_object_inline_stack_2731 = mountWorkInProgressOffscreenFiber({
                mode: "visible",
                children: JSCompiler_object_inline_stack_2731.children
            }, JSCompiler_object_inline_digest_2730), JSCompiler_object_inline_message_2729 = createFiberFromFragment(JSCompiler_object_inline_message_2729, JSCompiler_object_inline_digest_2730, renderLanes, null), JSCompiler_object_inline_message_2729.flags |= 2, JSCompiler_object_inline_stack_2731.return = workInProgress, JSCompiler_object_inline_message_2729.return = workInProgress, JSCompiler_object_inline_stack_2731.sibling = JSCompiler_object_inline_message_2729, workInProgress.child = JSCompiler_object_inline_stack_2731, reconcileChildFibers(workInProgress, current.child, null, renderLanes), JSCompiler_object_inline_stack_2731 = workInProgress.child, JSCompiler_object_inline_stack_2731.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_stack_2731.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2732, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress = JSCompiler_object_inline_message_2729);
            else if (pushPrimaryTreeSuspenseHandler(workInProgress), isHydrating && console.error("We should not be hydrating here. This is a bug in React. Please file a bug."), isSuspenseInstanceFallback(JSCompiler_object_inline_digest_2730)) {
                JSCompiler_object_inline_componentStack_2732 = JSCompiler_object_inline_digest_2730.nextSibling && JSCompiler_object_inline_digest_2730.nextSibling.dataset;
                if (JSCompiler_object_inline_componentStack_2732) {
                    JSCompiler_temp = JSCompiler_object_inline_componentStack_2732.dgst;
                    var message = JSCompiler_object_inline_componentStack_2732.msg;
                    instance = JSCompiler_object_inline_componentStack_2732.stck;
                    var componentStack = JSCompiler_object_inline_componentStack_2732.cstck;
                }
                JSCompiler_object_inline_message_2729 = message;
                JSCompiler_object_inline_digest_2730 = JSCompiler_temp;
                JSCompiler_object_inline_stack_2731 = instance;
                JSCompiler_temp = JSCompiler_object_inline_componentStack_2732 = componentStack;
                "POSTPONE" !== JSCompiler_object_inline_digest_2730 && (JSCompiler_object_inline_componentStack_2732 = JSCompiler_object_inline_message_2729 ? Error(JSCompiler_object_inline_message_2729) : Error("The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering."), JSCompiler_object_inline_componentStack_2732.stack = JSCompiler_object_inline_stack_2731 || "", JSCompiler_object_inline_componentStack_2732.digest = JSCompiler_object_inline_digest_2730, JSCompiler_object_inline_stack_2731 = void 0 === JSCompiler_temp ? null : JSCompiler_temp, JSCompiler_object_inline_message_2729 = {
                    value: JSCompiler_object_inline_componentStack_2732,
                    source: null,
                    stack: JSCompiler_object_inline_stack_2731
                }, "string" === typeof JSCompiler_object_inline_stack_2731 && CapturedStacks.set(JSCompiler_object_inline_componentStack_2732, JSCompiler_object_inline_message_2729), queueHydrationError(JSCompiler_object_inline_message_2729));
                workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
            } else if (didReceiveUpdate || propagateParentContextChanges(current, workInProgress, renderLanes, !1), JSCompiler_object_inline_componentStack_2732 = 0 !== (renderLanes & current.childLanes), didReceiveUpdate || JSCompiler_object_inline_componentStack_2732) {
                JSCompiler_object_inline_componentStack_2732 = workInProgressRoot;
                if (null !== JSCompiler_object_inline_componentStack_2732 && (JSCompiler_object_inline_stack_2731 = renderLanes & -renderLanes, JSCompiler_object_inline_stack_2731 = 0 !== (JSCompiler_object_inline_stack_2731 & 42) ? 1 : getBumpedLaneForHydrationByLane(JSCompiler_object_inline_stack_2731), JSCompiler_object_inline_stack_2731 = 0 !== (JSCompiler_object_inline_stack_2731 & (JSCompiler_object_inline_componentStack_2732.suspendedLanes | renderLanes)) ? 0 : JSCompiler_object_inline_stack_2731, 0 !== JSCompiler_object_inline_stack_2731 && JSCompiler_object_inline_stack_2731 !== prevState.retryLane)) throw prevState.retryLane = JSCompiler_object_inline_stack_2731, enqueueConcurrentRenderForLane(current, JSCompiler_object_inline_stack_2731), scheduleUpdateOnFiber(JSCompiler_object_inline_componentStack_2732, current, JSCompiler_object_inline_stack_2731), SelectiveHydrationException;
                JSCompiler_object_inline_digest_2730.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
                workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
            } else JSCompiler_object_inline_digest_2730.data === SUSPENSE_PENDING_START_DATA ? (workInProgress.flags |= 192, workInProgress.child = current.child, workInProgress = null) : (current = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_digest_2730.nextSibling), hydrationParentFiber = workInProgress, isHydrating = !0, hydrationErrors = null, didSuspendOrErrorDEV = !1, hydrationDiffRootDEV = null, rootOrSingletonContext = !1, null !== current && (warnIfNotHydrating(), idStack[idStackIndex++] = treeContextId, idStack[idStackIndex++] = treeContextOverflow, idStack[idStackIndex++] = treeContextProvider, treeContextId = current.id, treeContextOverflow = current.overflow, treeContextProvider = workInProgress), workInProgress = mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_stack_2731.children), workInProgress.flags |= 4096);
            return workInProgress;
        }
        if (JSCompiler_object_inline_message_2729) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_message_2729 = JSCompiler_object_inline_stack_2731.fallback, JSCompiler_object_inline_digest_2730 = workInProgress.mode, JSCompiler_temp = current.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2731 = createWorkInProgress(JSCompiler_temp, {
            mode: "hidden",
            children: JSCompiler_object_inline_stack_2731.children
        }), JSCompiler_object_inline_stack_2731.subtreeFlags = JSCompiler_temp.subtreeFlags & 65011712, null !== instance ? JSCompiler_object_inline_message_2729 = createWorkInProgress(instance, JSCompiler_object_inline_message_2729) : (JSCompiler_object_inline_message_2729 = createFiberFromFragment(JSCompiler_object_inline_message_2729, JSCompiler_object_inline_digest_2730, renderLanes, null), JSCompiler_object_inline_message_2729.flags |= 2), JSCompiler_object_inline_message_2729.return = workInProgress, JSCompiler_object_inline_stack_2731.return = workInProgress, JSCompiler_object_inline_stack_2731.sibling = JSCompiler_object_inline_message_2729, workInProgress.child = JSCompiler_object_inline_stack_2731, JSCompiler_object_inline_stack_2731 = JSCompiler_object_inline_message_2729, JSCompiler_object_inline_message_2729 = workInProgress.child, JSCompiler_object_inline_digest_2730 = current.child.memoizedState, null === JSCompiler_object_inline_digest_2730 ? JSCompiler_object_inline_digest_2730 = mountSuspenseOffscreenState(renderLanes) : (JSCompiler_temp = JSCompiler_object_inline_digest_2730.cachePool, null !== JSCompiler_temp ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? {
            parent: instance,
            pool: instance
        } : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_digest_2730 = {
            baseLanes: JSCompiler_object_inline_digest_2730.baseLanes | renderLanes,
            cachePool: JSCompiler_temp
        }), JSCompiler_object_inline_message_2729.memoizedState = JSCompiler_object_inline_digest_2730, JSCompiler_object_inline_message_2729.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2732, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2731;
        pushPrimaryTreeSuspenseHandler(workInProgress);
        ...
        null !== current && (JSCompiler_object_inline_componentStack_2732 = workInProgress.deletions, null === JSCompiler_object_inline_componentStack_2732 ? (workInProgress.deletions = [
            current
        ], workInProgress.flags |= 16) : JSCompiler_object_inline_componentStack_2732.push(current));
    ...
    (function() {
        ...
        if ("19.1.0-experimental-0ca3deeb-20250311" !== isomorphicReactPackageVersion) throw Error('Incompatible React versions: The "react" and "react-dom" packages must have the exact same version. Instead got:\n  - react:      ' + (isomorphicReactPackageVersion + "\n  - react-dom:  19.1.0-experimental-0ca3deeb-20250311\nLearn more: https://react.dev/warnings/version-mismatch"));
    })();
